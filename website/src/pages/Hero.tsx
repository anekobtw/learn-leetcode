  ...
  return (
    <>
      <div className="h-screen flex flex-col gap-3 items-center justify-center text-center">
        <h1 className="text-6xl font-sans tracking-wider">
